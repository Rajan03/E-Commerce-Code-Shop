...
import {productDetailsAction, productReviewAction} from "../redux/actions/productsActions";
...
export const ProductScreen = ({history, match}) => {
    ...
    const {success: reviewSuccess, error: reviewErr, loading: reviewLoading} = useSelector(
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        dispatch(productReviewAction(match.params.id, {rating, comment}));
    }
    return (
        <>
                        ...
                        <Col md={6}>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>
                                    ...
                                    {reviewErr && <Message variant={"danger"}>{reviewErr}</Message>}
                                    {userInfo
                                        ? (
                                            <Form onSubmit={submitHandler}>
                                                ...
                                                <Button type={"submit"} variant="primary" disabled={reviewLoading}>
                                                    {reviewLoading ? "wait.." : "Submit"}
                                                </Button>
                                            </Form>
                                        )
                                        :
                                        <Message>Please<Link to={'/login'}>Sign In</Link> to publish a
                                            review!!</Message>}
                                </ListGroup.Item>
                            </ListGroup>
                        </Col>
